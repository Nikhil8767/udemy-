...
import com.lms.course.dto.response.ValidationErrorResponse;
...
public class CourseExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleUnauthorized(RuntimeException ex, HttpServletRequest request) {
        HttpStatus status = "Access denied.".equals(ex.getMessage()) ? HttpStatus.FORBIDDEN : HttpStatus.UNAUTHORIZED;
